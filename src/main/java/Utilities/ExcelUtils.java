...
public class ExcelUtils {
    ...
    private static String filename = System.getProperty("user.dir")+ File.separator+"src"+File.separator+"main"+File.separator+"resources"+File.separator+"TestData.xlsx";
            //System.getProperty("src/main/resources/TestData.xlsx");
